      ...
      >
        ...
        >
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-foreground/15 backdrop-blur-md transition-all duration-300 hover:scale-110 hover:bg-foreground/25">
            <span className="font-sans text-xl font-bold text-foreground">Р</span>
          </div>
          <span className="font-sans text-xl font-semibold tracking-tight text-foreground">Туризм России</span>
        </button>
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="mb-6 animate-in fade-in slide-in-from-bottom-8 font-sans text-6xl font-light leading-[1.1] tracking-tight text-foreground duration-1000 md:text-7xl lg:text-8xl">
              <span className="text-balance">
                Россия — страна возможностей для каждого туриста
              </span>
            </h1>
            <p className="mb-8 max-w-xl animate-in fade-in slide-in-from-bottom-4 text-lg leading-relaxed text-foreground/90 duration-1000 delay-200 md:text-xl">
              <span className="text-pretty">
                Используем природное, культурное и историческое богатство страны для привлечения туристов всех возрастов и роста доходов регионов.
              </span>
            </p>
